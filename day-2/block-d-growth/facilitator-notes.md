...
- **Reading check-in:** Students should have read Grove Ch. 11 (Performance Reviews) and Fournier Ch. 6 (Managing a Team) before today. Reference these explicitly during the opening: "As Grove argues in Chapter 11, the performance review is the most important form of task-relevant feedback a manager can provide." Use Fournier's framing on managing up and team dynamics to set the stage for the calibration and SBI exercises. If students have not done the reading, they can still participate, but they will miss the conceptual foundation. Consider a quick show of hands: "Who finished the Grove chapter? The Fournier chapter?" This signals accountability without punishing those who fell behind.
